...
epi <- read.csv("../data_part/epi_data/VIW_FNT.csv") %>% 
...
world_region <- read.csv("../data_part/map_data/list_country.csv")
who_country <- read_xlsx("../data_part/map_data/WHO_country.xlsx")
...
#==map plot==
#we didn't provide the global map data as below due to the data sharing agreement
ggplot() +
