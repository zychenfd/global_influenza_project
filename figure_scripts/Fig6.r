...
#H3N2
tree_h3n2 <- read.beast("../genomic_part/post-analyses/mcc_tree/h3n2_from2011_mcc.tre")
tree_h3n2@phylo$edge.length[tree_h3n2@phylo$edge.length < 0] <- 0.00001
h3n2_even_meta <- read.csv("../genomic_part/post-analyses/mcc_tree/metadata_h3n2_even1.csv") %>% select(c("seqName", "region_final"))
...
#H1N1pdm09
tree_h1n1 <- read.beast("../genomic_part/post-analyses/mcc_tree/h1n1_from2011_mcc.tre")
tree_h1n1@phylo$edge.length[tree_h1n1@phylo$edge.length < 0] <- 0.00001
h1n1_even_meta <- read.csv("../genomic_part/post-analyses/mcc_tree/metadata_h1n1_even1.csv") %>% select(c("seqName", "region_final"))
...
#B/Victoria
tree_bv <- read.beast("../genomic_part/post-analyses/mcc_tree/bv_from2011_mcc.tre")
tree_bv@phylo$edge.length[tree_bv@phylo$edge.length < 0] <- 0.00001
bv_even_meta <- read.csv("../genomic_part/post-analyses/mcc_tree/metadata_bv_even1.csv") %>% select(c("seqName", "region_final"))
...
#==3.lineage turnover==
by_tmrca_hemi <- read.csv("../genomic_part/post-analyses/lineage_turnover_by/by_tmrca_hemi1.csv")
...
ratio <- read_xlsx("../genomic_part/post-analyses/nature_selection/ratio.xlsx")
h1n1_slac <- read.csv("../genomic_part/post-analyses/nature_selection/datamonkey-table-h1n1-slac.csv")
h3n2_slac <- read.csv("../genomic_part/post-analyses/nature_selection/datamonkey-table-h3n2-slac.csv")
bv_slac <- read.csv("../genomic_part/post-analyses/nature_selection/datamonkey-table-bv-slac.csv")
by_slac <- read.csv("../genomic_part/post-analyses/nature_selection/datamonkey-table-by-slac.csv")

h1n1_fubar <- read.csv("../genomic_part/post-analyses/nature_selection/datamonkey-table-h1n1-fubar.csv")
h3n2_fubar <- read.csv("../genomic_part/post-analyses/nature_selection/datamonkey-table-h3n2-fubar.csv")
bv_fubar <- read.csv("../genomic_part/post-analyses/nature_selection/datamonkey-table-bv-fubar.csv")
by_fubar <- read.csv("../genomic_part/post-analyses/nature_selection/datamonkey-table-by-fubar.csv")
